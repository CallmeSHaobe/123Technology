...
public class Circuit implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "boardTrans", 2))
            .itemInputs(
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "capTrans", 2))
            .itemInputs(
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "transTrans", 4))
            .itemInputs(
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "induTrans", 4))
            .itemInputs(
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "resTrans", 4))
            .itemInputs(
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "dioTrans", 4))
            .itemInputs(
                GT_ModHandler.getModItem("dreamcraft", "item.QuantumCircuit", 16),
            ...
            .addTo(MQFT);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "leCasimir", 16))
            .itemInputs(
            ...
            .addTo(ISA);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "finCasimir", 16))
            .itemInputs(
            ...
            .addTo(ISA);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "boardCasimir", 16))
            .itemInputs(
            ...
            .addTo(ISA);
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "energyHatchSpacetime", 4))
            .itemInputs(
        ...
        // UIV
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 1, 32174))
            .itemInputs(
        ...
        // UMV
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 1, 32175))
            .itemInputs(
        ...
        // UXV
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 1, 32176))
            .itemInputs(
        ...
        // MAX
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 1, 32177))
            .itemInputs(
        ...
        // TransSoC
        GT_Values.RA.stdBuilder()
            .itemOutputs(GT_ModHandler.getModItem("123Technology", "socInf", 1))
            .itemInputs(
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 64, 32081))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                GT_ModHandler.getModItem("123Technology", "socNor", 1))
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 64, 32078))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                GT_ModHandler.getModItem("123Technology", "socNor", 1))
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 64, 32080))
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                GT_ModHandler.getModItem("123Technology", "socNor", 2))
            .itemOutputs(GT_ModHandler.getModItem("gregtech", "gt.metaitem.03", 64, 32085))
