...
import com.dreammaster.gthandler.GT_MachineRecipeLoader;
...
public class Cyclotron implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                GT_ModHandler.getModItem("GalacticraftAmunRa","item.baseItem", 1, 26)
            )
            .fluidInputs(
                new FluidStack(FluidRegistry.getFluidID("molten.transcendentmetal"), 9216)
            )
            .outputChances(1230)
            .noOptimize()
            .duration(128 * 20)
