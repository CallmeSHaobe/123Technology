...
public class recipesMegaISAForge implements IRecipePool {
    ...
    public void loadRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemInputs(GTModHandler.getModItem("123Technology", "MetaItem", 1, 1))
            .itemOutputs(
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTModHandler.getModItem("123Technology", "MetaItem", 0, 13),
            ...
            .itemOutputs(GTModHandler.getModItem("123Technology", "MetaItem", 1, 13))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(
                ...
                GTModHandler.getModItem("123Technology", "MetaItem", 1, 13),
                GTModHandler.getModItem("gregtech", "gt.metaitem.03", 16, 4139),
                ItemList.Field_Generator_UMV.get(4))
            .itemOutputs(GTModHandler.getModItem("123Technology", "MetaItem", 4, 14))
            .fluidInputs(
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(GTModHandler.getModItem("123Technology", "MetaItem", 4, 20))
            .noOptimize()
            .duration(400 * 20)
            .eut(TierEU.RECIPE_MAX)
            .addTo(ISA);
        GTValues.RA.stdBuilder()
            .itemInputs(
                GTModHandler.getModItem("123Technology", "MetaItem", 8, 20),
        ...
        GTValues.RA.stdBuilder()
            ...
            .addTo(ISA);
        GTValues.RA.stdBuilder()
            .itemOutputs(GTModHandler.getModItem("123Technology", "MetaItem", 1, 18))
            .itemInputs(
            ...
            .addTo(ISA);
        GTValues.RA.stdBuilder()
            .itemOutputs(GTModHandler.getModItem("123Technology", "MetaItem", 4, 19))
            .itemInputs(
