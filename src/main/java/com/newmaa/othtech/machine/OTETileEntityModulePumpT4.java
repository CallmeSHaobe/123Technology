...
public abstract class OTETileEntityModulePumpT4 extends TileEntityModuleBase {
    ...
    protected OTETileEntityModulePumpT4(int aID, String aName, String aNameRegional, int tTier, int tModuleTier,
        int tMinMotorTier) {
        super(aID, aName, aNameRegional, tTier, tModuleTier, tMinMotorTier);
    }

    public OTETileEntityModulePumpT4(String aName, int moduleVoltageTier, int moduleTier, int minimumMotorTier) {
        super(aName, moduleVoltageTier, moduleTier, minimumMotorTier);
    }
    ...
    public static class ModulePumpT4OTE extends OTETileEntityModulePumpT4 {
         ...
         */
        public ModulePumpT4OTE(int aID, String aName, String aNameRegional) {
         ...
         * @param aName Name of the controller
         */
        public ModulePumpT4OTE(String aName) {
        ...
        public IMetaTileEntity newMetaEntity(IGregTechTileEntity iGregTechTileEntity) {
            return new ModulePumpT4OTE(mName);
        }
