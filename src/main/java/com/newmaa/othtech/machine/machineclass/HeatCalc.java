 ...
 */
public class HeatCalc extends MTEHatch implements IAddGregtechLogo, IAddUIWidgets {
    ...
    private static final Map<String, com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent> componentBinds = new HashMap<>();

    private String clientLocale = "en_US";

    public HeatCalc(int aID, String aName, String aNameRegional, int aTier) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public HeatCalc(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new com.newmaa.othtech.machine.machineclass.HeatCalc(mName, mTier, mDescriptionArray, mTextures);
    }
    ...
    private int getComputationPower(float overclock, float overvolt, boolean tickingComponents) {
        ...
        for (int i = 0; i < mInventory.length; i++) {
            ...
            com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent comp = componentBinds
                .get(TTUtility.getUniqueIdentifier(mInventory[i]));
            if (comp == null) {
                continue;
            }
    ...
    public static void run() { // 20k heat cap max!
        new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
        ...
        new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
            GTModHandler.getIC2Item("reactorVent", 1),
            0,
            -1,
            40f,
            20000,
            false); // Heat Vent
        new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
            GTModHandler.getIC2Item("reactorVentCore", 1),
            0,
            -1,
            80f,
            40000,
            false); // Reactor Heat Vent
        new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
            GTModHandler.getIC2Item("reactorVentGold", 1),
            0,
            -1,
            120f,
            60000,
            false); // Overclocked Heat
        // Vent
        new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
            GTModHandler.getIC2Item("reactorVentDiamond", 1),
            0,
            -1,
            160f,
            80000,
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            ...
            new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
                getModItem(NewHorizonsCoreMod.ID, "item.PikoCircuit", 1),
                260,
                12,
                -1f,
                95000,
                true); // UMV
            new com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent(
                getModItem(NewHorizonsCoreMod.ID, "item.QuantumCircuit", 1),
                320,
                10,
                -1f,
                100000,
    ...
    public static class RackComponent
        implements Comparable<com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent> {
        ...
        @Override
        public int compareTo(com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent o) {
            return unlocalizedName.compareTo(o.unlocalizedName);
        }

        @Override
        public boolean equals(Object obj) {
            if (obj instanceof com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent) {
                return compareTo((com.newmaa.othtech.machine.machineclass.HeatCalc.RackComponent) obj) == 0;
            }
            return false;
        }
    }
