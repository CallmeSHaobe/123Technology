...
public class OTH_OverclockCalculator {
     ...
     */
    public static OTH_OverclockCalculator ofNoOverclock(@Nonnull GTRecipe recipe) {
     ...
     */
    public static OTH_OverclockCalculator ofNoOverclock(long eut, int duration) {
        return new OTH_OverclockCalculator().setRecipeEUt(eut)
     ...
     */
    public OTH_OverclockCalculator() {}
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setRecipeEUt(long recipeEUt) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setEUt(long machineVoltage) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setDuration(int duration) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setAmperage(long machineAmperage) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator enablePerfectOC() {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setRecipeHeat(int recipeHeat) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setMachineHeat(int machineHeat) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setEUtDiscount(double aEUtDiscount) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setSpeedBoost(double aSpeedBoost) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setParallel(int aParallel) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setHeatDiscountMultiplier(double heatDiscountExponent) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setHeatPerfectOC(double heatPerfectOC) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setEUtIncreasePerOC(double eutIncreasePerOC) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setDurationDecreasePerOC(double durationDecreasePerOC) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setOneTickDiscount(boolean oneTickDiscount) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator limitOverclockCount(int maxOverclocks) {
    ...
    @Nonnull
    public OTH_OverclockCalculator setAmperageOC(boolean amperageOC) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setDurationUnderOneTickSupplier(Supplier<Double> supplier) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator setNoOverclock(boolean noOverclock) {
     ...
     */
    public OTH_OverclockCalculator setEutIncreasePerOCSupplier(Function<Integer, Double> eutIncreasePerOCSupplier) {
     ...
     */
    public OTH_OverclockCalculator setDurationDecreasePerOCSupplier(
     ...
     */
    public OTH_OverclockCalculator setCurrentParallel(int currentParallel) {
     ...
     */
    @Nonnull
    public OTH_OverclockCalculator calculate() {
        if (calculated) {
