package com.newmaa.othtech.machine.machineclass.processingLogics;
...
public class OTHOverclockCalculator {
     ...
     */
    public static OTHOverclockCalculator ofNoOverclock(@Nonnull GTRecipe recipe) {
     ...
     */
    public static OTHOverclockCalculator ofNoOverclock(long eut, int duration) {
        return new OTHOverclockCalculator().setRecipeEUt(eut)
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setRecipeEUt(long recipeEUt) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setEUt(long machineVoltage) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setDuration(int duration) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setAmperage(long machineAmperage) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator enablePerfectOC() {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setHeatOC(boolean heatOC) {
        this.heatOC = heatOC;
        return this;
    }
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setHeatDiscount(boolean heatDiscount) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setRecipeHeat(int recipeHeat) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setMachineHeat(int machineHeat) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setEUtDiscount(double aEUtDiscount) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setSpeedBoost(double aSpeedBoost) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setParallel(int aParallel) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setHeatDiscountMultiplier(double heatDiscountExponent) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setHeatPerfectOC(double heatPerfectOC) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setEUtIncreasePerOC(double eutIncreasePerOC) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setDurationDecreasePerOC(double durationDecreasePerOC) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setOneTickDiscount(boolean oneTickDiscount) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator limitOverclockCount(int maxOverclocks) {
    ...
    @Nonnull
    public OTHOverclockCalculator setAmperageOC(boolean amperageOC) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setDurationUnderOneTickSupplier(Supplier<Double> supplier) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator setNoOverclock(boolean noOverclock) {
     ...
     */
    public OTHOverclockCalculator setEutIncreasePerOCSupplier(Function<Integer, Double> eutIncreasePerOCSupplier) {
     ...
     */
    public OTHOverclockCalculator setDurationDecreasePerOCSupplier(
     ...
     */
    public OTHOverclockCalculator setCurrentParallel(int currentParallel) {
     ...
     */
    @Nonnull
    public OTHOverclockCalculator calculate() {
        if (calculated) {
