...
public class OTH_MTEHatchWirelessMulti extends MTEHatchEnergyMulti implements IWirelessEnergyHatchInformation {
    // From TecTech
    ...
    public OTH_MTEHatchWirelessMulti(int aID, String aName, String aNameRegional, int aTier, int aAmp) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public OTH_MTEHatchWirelessMulti(String aName, int aTier, int aAmp, String[] aDescription,
        ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OTH_MTEHatchWirelessMulti(mName, mTier, Amperes, mDescriptionArray, mTextures);
    }
