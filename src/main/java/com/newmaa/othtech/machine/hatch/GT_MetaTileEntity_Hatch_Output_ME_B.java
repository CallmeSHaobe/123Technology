...
public class GT_MetaTileEntity_Hatch_Output_ME_B extends MTEHatchOutput implements IPowerChannelState {
    ...
    public GT_MetaTileEntity_Hatch_Output_ME_B(int aID, String aName, String aNameRegional) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Hatch_Output_ME_B(mName, mTier, mDescriptionArray, mTextures);
    }
