...
public class OTEMetaTileEntity_Hatch_OutputBus_ME extends MTEHatchOutputBus implements IPowerChannelState {
    ...
    public OTEMetaTileEntity_Hatch_OutputBus_ME(int aID, String aName, String aNameRegional) {
        super(
            aID,
            aName,
            aNameRegional,
    ...
    public OTEMetaTileEntity_Hatch_OutputBus_ME(String aName, int aTier, String[] aDescription,
        ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OTEMetaTileEntity_Hatch_OutputBus_ME(mName, mTier, mDescriptionArray, mTextures);
    }
