...
public class OTEMetaTileEntity_Hatch_Output_ME extends MTEHatchOutput implements IPowerChannelState {
    ...
    public OTEMetaTileEntity_Hatch_Output_ME(int aID, String aName, String aNameRegional) {
        super(
            aID,
            aName,
            aNameRegional,
            ...
            new String[] { "为多方块机器输出流体", "直接存储到ME系统", "能够缓存无限数量的流体", "使用螺丝刀切换缓存模式", "手持剪线钳右键改变仓室与ME网络的连接方式",
                "来自 GT5.09.48.66, GTNH2.6.1, 123Technology" },
            1);
    }

    public OTEMetaTileEntity_Hatch_Output_ME(String aName, int aTier, String[] aDescription, ITexture[][][] aTextures) {
        super(aName, aTier, 1, aDescription, aTextures);
    }

    @Override
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OTEMetaTileEntity_Hatch_Output_ME(mName, mTier, mDescriptionArray, mTextures);
    }
