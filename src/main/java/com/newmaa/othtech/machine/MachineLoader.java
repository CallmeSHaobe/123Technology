...
public class MachineLoader {
    ...
    public static void loadMachines() {
        MegaIsaForge = new Mega_ISA_Forge(20000, "MegaISAForge", "§l神之艾萨锻炉").getStackForm(1);
        OTHItemList.MegaIsaForge.set(MegaIsaForge);

        inf_WirelessHatch = new infWirelessHatch(20001, "infWirelessEnergyHatch", "神人无线能源仓", 14).getStackForm(1);
        OTHItemList.inf_WirelessHatch.set(inf_WirelessHatch);

        legendary_WirelessHatch = new legendaryWireless(20002, "legendaryWirelessEnergyHatch", "传奇无线能源仓", 13)
            .getStackForm(1);
        OTHItemList.legendary_WirelessHatch.set(legendary_WirelessHatch);

        WirelessMAX = new MAXwireless(20003, "MAX1048576Hatch", "MAX 1,048,576A 无线能源仓", 14).getStackForm(1);
        OTHItemList.WirelessMAX.set(WirelessMAX);

        inf_infWirelessHatch = new WTFHatch(20004, "longlongHatch", "神威大将军毁天灭地无敌金刚炮无线能源仓", 14).getStackForm(1);
        OTHItemList.inf_infWirelessHatch.set(inf_infWirelessHatch);

        Mega_QFT = new MegaQFT(20005, "MegaQFT", "§l§b狄拉克潮汐").getStackForm(1);
