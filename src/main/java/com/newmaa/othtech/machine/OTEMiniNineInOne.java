...
public class OTEMiniNineInOne extends OTHMultiMachineBase<OTEMiniNineInOne> {

    public OTEMiniNineInOne(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public OTEMiniNineInOne(String aName) {
        super(aName);
    }
    ...
    private static IStructureDefinition<com.newmaa.othtech.machine.OTEMiniNineInOne> STRUCTURE_DEFINITION = null;
    ...
    @Override
    public IStructureDefinition<OTEMiniNineInOne> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<OTEMiniNineInOne>builder()
                .addShape(STRUCTURE_PIECE_MAIN, shapeMain)
                .addElement('D', ofBlock(ModBlocks.blockCasings3Misc, 2))
                .addElement(
                    'E',
                    buildHatchAdder(com.newmaa.othtech.machine.OTEMiniNineInOne.class)
                        .atLeast(
                            InputBus,
                            OutputBus,
                            InputHatch,
                        ...
                        .adder(com.newmaa.othtech.machine.OTEMiniNineInOne::addToMachineList)
                        .dot(1)
    ...
    // spotless:off
        ...
        public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
            return new com.newmaa.othtech.machine.OTEMiniNineInOne(this.mName);
        }
