...
// From TST
public class OTH_TE_Hatch_MEIO extends GT_MetaTileEntity_Hatch
    ...
    public OTH_TE_Hatch_MEIO(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount,
    ...
    public OTH_TE_Hatch_MEIO(String aName, int aTier, int aInvSlotCount, String aDescription,
        ITexture[][][] aTextures) {
    ...
    public OTH_TE_Hatch_MEIO(String mName, byte mTier, String[] mDescriptionArray, ITexture[][][] mTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OTH_TE_Hatch_MEIO(mName, mTier, mDescriptionArray, mTextures);
    }
