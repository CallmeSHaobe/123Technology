...
import static com.newmaa.othtech.system.RecipePattern.CustomCraftRecipe.combineAnyStackList;
...
// From TST
public class OTEHatchMEIO extends MTEHatch implements IConfigurationCircuitSupport, IAddGregtechLogo, IAddUIWidgets,
    IPowerChannelState, ICraftingProvider, IGridProxyable, IDualInputHatch, ICustomNameObject, IInterfaceViewable {

    public OTEHatchMEIO(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount, String aDescription,
        ITexture... aTextures) {
        super(aID, aName, aNameRegional, aTier, aInvSlotCount, aDescription, aTextures);
    }

    public OTEHatchMEIO(int aID, String aName, String aNameRegional, int aTier, int aInvSlotCount,
        String[] aDescription, ITexture... aTextures) {
        super(aID, aName, aNameRegional, aTier, aInvSlotCount, aDescription, aTextures);
    }

    public OTEHatchMEIO(String aName, int aTier, int aInvSlotCount, String aDescription, ITexture[][][] aTextures) {
    ...
    public OTEHatchMEIO(String mName, byte mTier, String[] mDescriptionArray, ITexture[][][] mTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new OTEHatchMEIO(mName, mTier, mDescriptionArray, mTextures);
    }
