...
import com.newmaa.othtech.Utils.TextHandler;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ItemISA_Basic extends Item {

    public List<String> tooltips = new ArrayList<>();

    public String unlocalizedName;

    public ItemISA_Basic(String Name, String MetaName, CreativeTabs aCreativeTabs/* , String aIconPath */) {
        super();
