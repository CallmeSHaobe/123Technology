...
import com.newmaa.othtech.common.creativetab.CreativeTabsothtech;
...
public class itemCombs extends Item{
    ...
    public static void initCombsRecipes() {
        ...
        RecipeBuilder.builder()
            ...
            .itemOutputs(
                GTModHandler.getModItem(GTPlusPlus.ID, "blockBlockAstralTitanium", 4)
            )
            .fluidInputs(
        ...
        RecipeBuilder.builder()
            ...
            .itemOutputs(
                GTModHandler.getModItem(GTPlusPlus.ID, "blockBlockAstralTitanium", 2)
            )
            .fluidInputs(
        ...
        RecipeBuilder.builder()
            ...
            .itemOutputs(
                GTModHandler.getModItem(GTPlusPlus.ID, "itemDustChromaticGlass", 2)
            )
            .duration(250*20)
        ...
        RecipeBuilder.builder()
            .itemInputs(
                combTypes.NORMALGLASS.getStackForType(1)
            )
            .itemOutputs(
                new ItemStack(Blocks.glass, 1),
                GTModHandler.getModItem(Forestry.ID, "honeyDrop", 1)
            )
