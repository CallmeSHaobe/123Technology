...
public enum OTHCombTypes {
    ...
    private static void map(int aId, OTHCombTypes aType) {
        OTHBeeyonds.sCombMappings.put(aId, aType);
    }

    public static OTHCombTypes get(int aID) {
        return OTHBeeyonds.sCombMappings.get(aID);
    }

    OTHCombTypes(int aID, String aName, boolean aShow, int aChance, int... aColour) {
        this.mID = aID;
        this.mName = aName;
